...
typedef struct CSDV1 {
  ...
  byte c_size_low :2;
  // byte 9
  byte c_size_mult_high : 2;
  byte vdd_w_cur_max : 3;
  byte vdd_w_curr_min : 3;
  // byte 10
  byte sector_size_high : 6;
  byte erase_blk_en : 1;
  byte c_size_mult_low : 1;
  // byte 11
  byte wp_grp_size : 7;
  byte sector_size_low : 1;
  // byte 12
  byte write_bl_len_high : 2;
  byte r2w_factor : 3;
  byte reserved3 : 2;
  byte wp_grp_enable : 1;
  // byte 13
  byte reserved4 : 5;
  byte write_partial : 1;
  byte write_bl_len_low : 2;
  // byte 14
  byte reserved5: 2;
  byte file_format : 2;
